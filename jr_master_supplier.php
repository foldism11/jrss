...
<script language=javascript1.2 src='js/jr_master_supplier.js'></script>
                        ...
                        $optstts.="<option value='" . $key . "'>" . $value. "</option>";
                                ...
                                echo"<table style='font-size:12px; width: 450px;'>";
                                 ...
                                 echo"<tr>
                                        <th>Telepon</th>
                                        <th></th>
                                        <th align='left'><input class='form-control filter' type=text class=myinputtextnumber id=tlp name=tlp onkeypress=\"return angka_doang(event);\" style='height:25px; width:300px;' /></th>
                                        <td></td>
                                     </tr>";
                                 echo"<tr>
                                        <th>Email</th>
