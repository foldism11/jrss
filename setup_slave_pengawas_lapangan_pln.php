...
switch ($method) {
        ...
        $strx = "select max(nik_pl) as jumlah from " . $dbname . ".mst_pengawas_lapangan_pln";
        ...
        $str="insert into ".$dbname.".mst_pengawas_lapangan_pln (kode_upt,nik_pl,nama_pl,status,alamat,email,telepon)
       ...
       // exit('error'.$str);
        ...
        $supdt="update ".$dbname.".mst_pengawas_lapangan_pln set kode_upt='".$upt."',nama_pl='".$nama."',status='".$status."',alamat='".$alamat."',email='".$email."',telepon='".$tlp."' where nik_pl = '".$kode."'";
    ...
    break;
        ...
        case'loadData':
            ...
            $str = "select * from " . $dbname . ".mst_pengawas_lapangan_pln order by nama_pl ";
            ...
            while ($d = $n->fetch()) {
                ...
                $tab.="<td align=left>" . $d['nama_pl']. "</td>";          
                $tab.="<td align=left>" . $d['telepon']. "</td>";          
                $tab.="<td align=left>" . $d['email']. "</td>";          
                $tab.="<td align=left>" . $d['alamat']. "</td>";          
                $tab.="<td align=left>" .$arr[$d['status']]. "</td>";          

                $tab.="<td align=left><a style='color:white'; class='btn btn-info btn-sm' onclick=\"edit('".$d['kode_upt']."','".$d['nik_pl']."','".$d['nama_pl']."','".$d['telepon']."','".$d['email']."','".$d['alamat']."','".$d['status']."');\"><i class='fas fa-pencil-alt'></i>Edit
                </a></td>";
