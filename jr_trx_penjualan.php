...
<script language=javascript1.2 src='js/jr_trx_penjualan.js'></script>
                ...
                <div class="form-group">
                 ...
                 <div class="card-header">
                  ...
                  <?php
                      ...
                      @$optbarang="<option value=''>Pilih Data</option>";
                

                      $strbarang = "select * from " . $dbname . ".mst_stock where  tot_qty_conv1 > '0' and cabang='".$_SESSION['standard']['cabang']."'";
                      ...
                      while ($barbarang = $resbarang->fetch()) {
                         $optcabang=makeOption($dbname,'mst_barang','kode_barang,nama_barang',"kode_barang='".$barbarang->kode_barang."'");
                            @$optbarang.="<option value='" . $barbarang->kode_barang ."'>" . $optcabang[$barbarang->kode_barang]. " </option>";
                      ...
                      while ($barcabang = $rescabang->fetch()) {
                            ...
                            @$optcabang.="<option value='" . $barcabang->kode_cabang ."'>" . $barcabang->nama_cabang. " </option>";
                             ...
                             echo"<tr>
                                        <th ><span style='color: black'>Tanggal Transaksi</span></th>
                                        <td></td><td>";
                                        ?>
                     ...
                     echo" </table><br><br>";
                      ...
                      echo"<tr>
                        ...
                        <td> <button  style='width:100px;' type='button' class='btn btn-block btn-success' onclick=simpanhead() >Simpan</button></td>
                        <td> <button  style='width:100px;' type='button' class='btn btn-block btn-success' onclick=cancelIsi()>Batal</button></td>
                        <td> <button  style='width:100px;' type='button' class='btn btn-block btn-success' onclick=upload()>Upload</button></td>
                      </tr>
                      </table>";
          ...
          <div class="card" id="detail" style="display:none;">
             ...
             <div class="card-header">
              ...
              <div class="card-body">
                ...
                <th>Nama Barang</th>
                <th></th>
                <td align='left' id=\"brgx\"><select id=\"brg\" name=\"brg\" class='form-control select2' style='height:35px; width:300px;' onchange=\"getdata()\">".$optbarang."</select></td>
                ...
                <th>Satuan</th>
                <th></th>
                <th align='left'><input disabled class='form-control filter' type=text class=myinputtext id=satuan name=satuan onkeypress=\"return angka_doang(event);\" style='height:25px; width:350px;' /></th>
                <td></td>
                </tr>";
                ...
                <th>Harga</th>
                <th></th>
                <th align='left'><input disabled class='form-control filter' type=text class=myinputtext id=harga name=harga onkeypress=\"return angka_doang(event);\" style='height:25px; width:350px;' /></th>
                <td></td>
                </tr>";
                ...
                <th>QTY</th>
                <th></th>
                <th align='left'><input class='form-control filter' type=text class=myinputtext id=qty name=qty onkeyup=\"z.numberFormat('qty',2);\" onkeypress=\"return angka_doang(event);\" onchange=\"getjum();\" style='height:25px; width:350px;' /></th>
                <td></td>
                </tr>"; 
                ...
                <th>Jumlah</th>
                <th></th>
                <th align='left'><input class='form-control filter' type=text class=myinputtext id=jum name=jum onkeyup=\"z.numberFormat('jum',2);\" onkeypress=\"return angka_doang(event);\" style='height:25px; width:350px;' /></th>
                <td></td>
                </tr>";   
