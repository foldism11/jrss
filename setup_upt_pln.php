...
<script language=javascript1.2 src='js/setup_upt_pln.js'></script>
                 ...
                 <!--  <label>Minimal</label>
                  ...
                  <?php
                      #data nama penyedia barang dan jasa
                       $optprovinsi=$optstts="<option value=''>Pilih Data</option>";
                                  ...
                                  echo"<table style='font-size:12px; width: 450px;'>";
                                     echo"<tr>";
                                      echo "<td>";
                                          ...
                                          <th>Nama UPT</th>
                                          <th></th>
                                          <th align='left'><input class='form-control filter' type=text class=myinputtext id=nama name=nama onkeypress=\"return tanpa_kutip(event);\" onkeyup='this.value = this.value.toUpperCase()' style='height:25px; width:300px;' /></th>
                                          <td></td>
                                          </tr>";
                                          echo"<tr>
                                          <th>Email</th>
                                          <th></th>
                                          <th align='left'><input class='form-control filter' type=text class=myinputtext id=email name=email onkeypress=\"return tanpa_kutip(event);\" style='height:25px; width:300px;' /></th>
                                          <td></td>
                                          </tr>";
                                          echo"<tr>
                                          <th>No Telepon</th>
                                          <th></th>
                                          <th align='left'><input class='form-control filter' type=text class=myinputtext id=tlpn name=tlpn onkeypress=\"return angka_doang(event);\" style='height:25px; width:300px;' /></th>
                                          <td></td>
                                          </tr>";
                                          echo"<tr>
                                          <th>Status</th>
                                      ...
                                      echo "<td>";
                                          ...
                                          echo "<th>Provinsi</th>
                                          <td></td>
                                          <td colspan=2 align='left'><select id=\"propinsi\" name=\"propinsi\" style='height:25px; width:300px;'>".$optprovinsi."</select></td>
                                          ...
                                          <th>Kode Pos</th>
                                          <td></td>
                                          <td align='left' ><input class='form-control' type=text class=myinputtext id=pos name=pos onkeypress=\"return angka_doang(event);\" style='height:25px; width:100px;' /></td>
                                          </tr>";
