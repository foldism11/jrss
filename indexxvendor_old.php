                         ...
                         echo "<table>";
                            echo "<tr>";
                               echo "<td>";
                                 echo "<table>";
                                  echo "<tr>";
                                     echo " <td align=center width='450px' class='active'><a href='pln_kontrak_form.php'><img src=images/monitoringvendor.png width='150px' height='120px' class=resicon caption='Monitoring'></a></td>";
                                     echo " <td align=center width='450px'><a href='pln_monitoring_kontrak.php'><img src=images/rkvendor.png width='150px' height='120px' class=resicon caption='Rencana Pekerjaan'></a></td>";
                                     echo " <td align=center width='450px'><a href='pln_kelengkapan_berkas.php'><img src=images/appdrawing.png width='150px' height='120px' class=resicon caption='APP Drawing'</a></td>";
                                  echo "</tr>";

                                  echo "<tr>";
                                   echo " <td align=center>Monitoring</td>";
                                   echo " <td align=center>Rencana Pekerjaan</td>";
                                   echo " <td align=center>Pengajuan APP Drawing</td>";
                                echo "</tr>";
