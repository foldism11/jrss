...
switch ($method) {
        ...
        $strx = "select max(nik_dp) as jumlah from " . $dbname . ".mst_direksi_pekerjaan_pln";
        ...
        $str="insert into ".$dbname.".mst_direksi_pekerjaan_pln (kode_upt,nik_dp,nama_dp,status,alamat,email,telepon)
       ...
       // exit('error'.$str);
        ...
        $supdt="update ".$dbname.".mst_direksi_pekerjaan_pln set kode_upt='".$upt."',nama_dp='".$nama."',status='".$status."',alamat='".$alamat."',email='".$email."',telepon='".$tlp."' where nik_dp = '".$kode."'";
    ...
    break;
        ...
        case'loadData':
            ...
            $str = "select * from " . $dbname . ".mst_direksi_pekerjaan_pln order by nama_dp ";
            ...
            while ($d = $n->fetch()) {
                ...
                $tab.="<td align=left>" . $d['nama_dp']. "</td>";          
                $tab.="<td align=left>" . $d['telepon']. "</td>";          
                $tab.="<td align=left>" . $d['email']. "</td>";          
                $tab.="<td align=left>" . $d['alamat']. "</td>";          
                $tab.="<td align=left>" .$arr[$d['status']]. "</td>";          

                $tab.="<td align=left><a style='color:white'; class='btn btn-info btn-sm' onclick=\"edit('".$d['kode_upt']."','".$d['nik_dp']."','".$d['nama_dp']."','".$d['telepon']."','".$d['email']."','".$d['alamat']."','".$d['status']."');\"><i class='fas fa-pencil-alt'></i>Edit
                </a></td>";
