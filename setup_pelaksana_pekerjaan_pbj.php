...
<script language=javascript1.2 src='js/setup_pelaksana_pekerjaan_pbj.js'></script>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="setup_pelaksana_pekerjaan_pbj.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Master Pelaksana Pekerjaan</h1>
          </div>
                  ...
                  <?php
                      ...
                      foreach ($arr as $key => $value) {
                        $optstts.="<option value='" . $key . "'>" . $value. "</option>";
                                ...
                                echo"<tr>
                                      <th width='200px'>Nama Pelaksana</th>
                                      <th></th>
