...
OPEN_BOX('','<span class=judul>'.strtoupper('Manage Account').'</span>');
echo OPEN_THEME('Active/Deactive/Delete Users:');
echo"<br><fieldset>
     <legend><img src='images/useraccounts.png' height=40px style='vertical-align:middle;'><b>Activate/Deactivate/Delete Users Account:</b></legend> 
