...
<script language=javascript1.2 src='js/jr_lap_stock.js'></script>
                      ...
                      while ($barsupp = $ressupp->fetch()) {
                            ...
                            echo"<table style='font-size:12px; width: 450px;'>";
                                  ...
                                  echo"<br><tr>
                                        ...
                                        <th>Cabang</th>
                                        <th></th>
                                        <td align='left' ><select id=\"cabang\" name=\"cabang\" style='height:25px; width:350px;'>".$optcabang."</select></td>
                                        <td></td>
                                        </tr>";
                                 ...
                                 /*  echo"<tr>
                                    <th>&nbsp;</th>
                                        <th>Supplier</th>
                                        <th></th>
                                        <td align='left' ><select id=\"supp\" name=\"supp\" style='height:25px; width:350px;'>".$optsupp."</select></td>
                                        <td></td>
                                     </tr>";  */
