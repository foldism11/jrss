...
<script language=javascript1.2 src='js/jr_trx_atk.js'></script>
          ...
          <div class="card" id="detail" style="display:none;">
             ...
             <div class="card-header">
              ...
              <div class="card-body">
                ...
                <th>Nama Barang</th>
                <th></th>
                <th align='left'><input  class='form-control filter' type=text class=myinputtext id=brg name=brg onkeypress=\"return tanpa_kutip(event);\" style='height:25px; width:350px;'></th>
                </tr>"; 
                ...
                <th>Harga</th>
                <th></th>
                <th align='left'><input  class='form-control filter' type=text class=myinputtext id=harga name=harga onkeypress=\"return angka_doang(event);\" style='height:25px; width:350px;' /></th>
                <td></td>
                </tr>";
