 ...
 <!-- /.card-body -->
          ...
          <div id="list" class="card">
              ...
              <div class="card-body">
                ...
                ?>
                <a href="../jr_trx_penjualan.php" class="btn btn-danger pull-right">
              ...
              <form method="post" action="" enctype="multipart/form-data">
                <a href="Format_Jual.csv" class="btn btn-default">
              ...
              if(isset($_POST['preview'])){
                ...
                if($ext == "csv"){
                  ...
                  echo "<form method='post' action='importjual.php'>";

                  // Buat sebuah div untuk alert validasi kosong
                /*  echo "<div class='alert alert-danger' id='kosong'>
                  Anda Tidak Dapat Mengupload Data, Ada <span id='jumlah_kosong'></span> data yang belum lengkap diisi Atau Dengan Format yg Salah.
                  </div>";*/
                  ...
                  foreach ($worksheet->getRowIterator() as $row) { // Lakukan perulangan dari data yang ada di csv
                    ...
                    if($numrow > 1){
                     ...
                     if($faktur == "" && $cabang == "" && $tanggal_transaksi == "" && $kode_barang == "" && $qty_pcs == ""  && $harsat == ""  && $harga_rupiah == "")
                      ...
                      $tanggal_transaksi_td = ($tanggal_transaksi == "")? " style='background: #E07171;'" : ""; // Jika Telepon kosong, beri warna merah
                      ...
                      $harsat_td = ($harsat == "")? " style='background: #E07171;'" : ""; // Jika Alamat kosong, beri warna merah
                      $harga_rupiah_td = ($harga_rupiah == "")? " style='background: #E07171;'" : ""; // Jika Alamat kosong, beri warna merah
                     

                      // Jika salah satu data ada yang kosong
                       // Jika salah satu data ada yang kosong
                      if($faktur == "" or $cabang == ""   or $tanggal_transaksi == "" or $kode_barang == ""  or  $qty_pcs == "" or $harsat == "" or $harga_rupiah == ""){
                        $kosong++; // Tambah 1 variabel $kosong
                      }
                      echo "<tr>";
                      echo "<td".$faktur_td.">".$faktur."</td>";
                      echo "<td".$cabang_td.">".$cabang."</td>";
                      echo "<td".$tanggal_transaksi_td.">".$tanggal_transaksi."</td>";
                      echo "<td".$kode_barang_td.">".$kode_barang."</td>";
                      echo "<td".$qty_pcs_td.">".$qty_pcs."</td>";
                      echo "<td".$harsat_td.">".$harsat."</td>";
