...
<script language=javascript1.2 src='js/setup_pbj.js'></script>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
               <li class="nav-item">
                <a href="setup_pbj.php" class="nav-link active">
                  ...
                  <?php
                      ...
                      foreach ($arr as $key => $value) {
                        $optstts.="<option value='" . $key . "'>" . $value. "</option>";
                                ...
                                echo"<tr>
                                      <th>No Telepon</th>
                                      <th></th>
                                      <th align='left'><input class='form-control filter' type=text class=myinputtext id=tlp name=tlp onkeypress=\"return angka_doang(event);\" style='height:25px; width:300px;' /></th>
                                      <td></td>
                                     </tr>";
                     ...
                     echo" </table><br><br>";
                      ...
                      echo"<tr>
                        ...
                        <td> <button  style='width:100px;' type='button' class='btn btn-block btn-primary' onclick=simpan(".$_SESSION['standard']['tipex'].") >Simpan</button></td>
