...
<script language=javascript1.2 src='js/setup_pengawas_lapangan_pln.js'></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Master Pengawas Lapangan</h1>
          </div>
                ...
                <div class="form-group">
                 <!--  <label>Minimal</label>
                  ...
                  <?php
                      ...
                      $optuptpln=$optstts="<option value=''>Pilih Data</option>";
                

                      #data UPT 
                      $struptpln = "select kode_upt,nama_upt from " . $dbname . ".mst_upt_pln where status='1'";
                      $resuptpln=$owlPDO->query($struptpln) or die(print " Gagal: ".PDOException::getMessage());
                      $resuptpln->setFetchMode(PDO::FETCH_OBJ);
                      while ($baruppln = $resuptpln->fetch()) {
                        $optuptpln.="<option value='" . $baruppln->kode_upt . "'>" . $baruppln->nama_upt. "</option>";
                      }
                      ...
                      foreach ($arr as $key => $value) {
                        $optstts.="<option value='" . $key . "'>" . $value. "</option>";
                                ...
                                echo"<tr>
                                        <th>Unit UPT</th>
                                        <th></th>
                                        <td align='left'><select id=\"upt\" name=\"upt\" style='height:25px; width:300px;'>".$optuptpln."</select></td>
                                        <td></td>
                                     </tr>";
                                ...
                                echo"<tr>
                                      <th width='200px'>Nama pengawas</th>
                                      <th></th>
