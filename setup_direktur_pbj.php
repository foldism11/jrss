...
<script language=javascript1.2 src='js/setup_direktur_pbj.js'></script>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
             <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="setup_direktur_pbj.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Direktur</p>
                </a>
              </li>
                  ...
                  <?php
                      ...
                      foreach ($arr as $key => $value) {
                        $optstts.="<option value='" . $key . "'>" . $value. "</option>";
                                ...
                                echo"<tr>
                                      <th width='200px'>Nama Direktur</th>
                                      <th></th>
